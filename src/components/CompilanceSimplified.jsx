			...
			<div className="container grid grid-cols-2 w-[1304px] h-[900px] mx-60 p-12 gap-5 ">
				<div className="left my-14 flex flex-col gap-3 p-9">
					...
					<p className="text-gray-500 leading-8">
						With Increasing regulations, more and more business are required by
						law to comply with sustainability reporting. Part of the mandatory
						ESG Compliance regulation in the EU is energy reporting & reduction
						strategy, this is what OAK has specialised in and automates for you
